...
edge::
If the router mode is 'edge', this is '1' if there are destinations reachable via the edge uplink.  If the router mode is 'interior', this is the number of destinations for this address on locally-connected edge routers.
